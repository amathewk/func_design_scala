...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$solutions__D__D__D__D__sci_Set($uD(a$2.apply__O()), $uD(b$2.apply__O()), $uD(c$2.apply__O()), $uD(delta$1.apply__O()))
    })
  })(a, b, c, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$solutions__D__D__D__D__sci_Set = (function(a, b, c, delta) {
  var ans = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  if ((delta > 0.0)) {
    ans = $as_sci_Set(ans.$$plus__O__sc_Set(((-b) + ($uD($g["Math"]["sqrt"](delta)) / (2 * a)))));
    ans = $as_sci_Set(ans.$$plus__O__sc_Set(((-b) - ($uD($g["Math"]["sqrt"](delta)) / (2 * a)))))
  } else if ((a === 0.0)) {
    ans = $as_sci_Set(ans.$$plus__O__sc_Set((((-b) / 2) * a)))
  };
  return ans
});
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$colr__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$colr__I__T = (function(rem) {
  switch (rem) {
    default:
      return ((rem > 14) ? "green" : ((rem >= 0) ? "orange" : "red"));
  }
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, sig$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(sig$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, sig));
